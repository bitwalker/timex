...
defimpl Date.Convert, for: DateTime do
  def to_gregorian(DateTime[year: y, month: m, day: d, hour: h, minute: min, second: sec, timezone: TimezoneInfo[full_name: name, gmt_offset_std: offset]]) do
    { {y, m, d}, {h, min, sec}, {offset / 60, name} }
  end
