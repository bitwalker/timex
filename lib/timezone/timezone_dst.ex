defmodule Timezone.Dst do
  ...
  """
  @spec is_dst?(DateTime.t) :: true | false | :ambiguous_time | :invalid_time
  ...
  defp is_dst_start_time(current_time, start_time, shift) when current_time >= (start_time + shift), do: true
  defp is_dst_start_time(_, _, _), do: :invalid_time

  defp is_dst_end_time(current_time, end_time, _shift) when current_time < end_time, do: true
  defp is_dst_end_time(current_time, end_time, shift) when current_time >= (end_time + shift), do: false
  defp is_dst_end_time(_current_time, _end_time, _shift), do: :ambiguous_time
