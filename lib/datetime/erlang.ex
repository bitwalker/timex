defimpl Timex.Protocol, for: Tuple do
  ...
  @spec to_julian(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          float | {:error, term}
  ...
  @spec to_gregorian_seconds(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          non_neg_integer
  ...
  @spec to_gregorian_microseconds(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          non_neg_integer
  ...
  @spec to_datetime(
          Types.date() | Types.datetime() | Types.microsecond_datetime(),
          Types.valid_timezone()
        ) ::
  ...
  def to_datetime({{y, m, d}, {h, mm, s, _us}} = dt, timezone)
  ...
  @spec to_naive_datetime(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          NaiveDateTime.t()
  ...
  @spec to_erl(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec beginning_of_day(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec end_of_day(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec beginning_of_year(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec end_of_year(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec beginning_of_quarter(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec end_of_quarter(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec beginning_of_month(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec end_of_month(Types.date() | Types.datetime() | Types.microsecond_datetime()) ::
          Types.date() | Types.datetime() | Types.microsecond_datetime()
  ...
  @spec set(Types.date() | Types.datetime() | Types.microsecond_datetime(), list({atom(), term})) ::
